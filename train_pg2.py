...
class Agent(object):
    ...
    def policy_forward_pass(self, sy_ob_no):
        ...
        if self.discrete:
            ...
            # START OF YOUR CODE
            # ------------------------------------------------------------------
            sy_logits_na = build_mlp(input_placeholder=sy_ob_no, output_size = self.ac_dim, scope = "disc", n_layers=self.n_layers, size=self.size)
            ...
            sy_logstd = tf.Variable(tf.ones((1,self.ac_dim)))
            # ------------------------------------------------------------------
            # END OF YOUR CODE
            # ------------------------------------------------------------------
    ...
    def sample_action(self, policy_parameters):
        ...
        if self.discrete:
            ...
            # START OF YOUR CODE
            # ------------------------------------------------------------------
            #sy_sampled_ac = tf.distributions.Categorical(logits=sy_logits_na, probs = )
    ...
    def build_computation_graph(self):
        ...
        # START OF YOUR CODE
        # ------------------------------------------------------------------
        self.loss = -1 * tf.reduce_mean(self.sy_logprob_n * self.sy_adv_n)
        # ------------------------------------------------------------------
        # END OF YOUR CODE
        # ------------------------------------------------------------------
